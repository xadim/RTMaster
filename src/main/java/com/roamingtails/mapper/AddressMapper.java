...
import com.roamingtails.model.AddressLocator;
...
public class AddressMapper {
	...
	public RestaurantResponse getLongitudeLatitude(String address, Restaurants rest) {
		RestaurantMapper restMapper = new RestaurantMapper();
		RestaurantResponse location = new RestaurantResponse();
		location = restMapper.mapRestResponse(rest);
		try {
            ...
            try {
                ...
                location.setLatitude(strLatitude);
                ...
                location.setLongitude(strLongtitude); 
	...
	public String constructAddress(Restaurants rest)
	{
		String address =  rest.getAddress1()+ "," + rest.getCity()+ rest.getState()+rest.getZipCode();
		return address;
	}
}
